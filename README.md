# BMTLab.StateResults [![NuGet](https://img.shields.io/nuget/v/OneOf?logo=nuget)](https://www.nuget.org/packages/BMTLab.StateResults) ![.NET](https://github.com/BMTLab/StateResults/workflows/Release/badge.svg)
